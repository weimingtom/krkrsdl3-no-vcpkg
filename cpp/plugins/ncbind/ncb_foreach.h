...
#define FOREACH_SPACE_EXT(EXT) \
    EXT(1) \
    EXT(2) EXT(3) EXT(4) EXT(5) EXT(6) EXT(7) EXT(8) EXT(9) EXT(10) EXT(11) EXT(12) EXT(13) \
        EXT(14)
#undef FOREACH_COMMA_EXT
#define FOREACH_COMMA_EXT(EXT) \
    EXT(1), EXT(2), EXT(3), EXT(4), EXT(5), EXT(6), EXT(7), EXT(8), EXT(9), EXT(10), EXT(11), \
...
#define FOREACH_COMMA_EXT(EXT) \
    EXT(1), EXT(2), EXT(3), EXT(4), EXT(5), EXT(6), EXT(7), EXT(8), EXT(9), EXT(10), EXT(11), \
        EXT(12), EXT(13), EXT(14), EXT(15), EXT(16), EXT(17)
FOREACH
#endif
...
#define FOREACH_SPACE_EXT(EXT) \
    EXT(1) \
    EXT(2) EXT(3) EXT(4) EXT(5) EXT(6) EXT(7) EXT(8) EXT(9) EXT(10) EXT(11) EXT(12) EXT(13) \
        EXT(14) EXT(15) EXT(16) EXT(17) EXT(18)
#undef FOREACH_COMMA_EXT
#define FOREACH_COMMA_EXT(EXT) \
    EXT(1), EXT(2), EXT(3), EXT(4), EXT(5), EXT(6), EXT(7), EXT(8), EXT(9), EXT(10), EXT(11), \
        EXT(12), EXT(13), EXT(14), EXT(15), EXT(16), EXT(17), EXT(18)
FOREACH
#endif
...
#define FOREACH_SPACE_EXT(EXT) \
    EXT(1) \
    EXT(2) EXT(3) EXT(4) EXT(5) EXT(6) EXT(7) EXT(8) EXT(9) EXT(10) EXT(11) EXT(12) EXT(13) \
        EXT(14) EXT(15) EXT(16) EXT(17) EXT(18) EXT(19)
#undef FOREACH_COMMA_EXT
#define FOREACH_COMMA_EXT(EXT) \
    EXT(1), EXT(2), EXT(3), EXT(4), EXT(5), EXT(6), EXT(7), EXT(8), EXT(9), EXT(10), EXT(11), \
...
#define FOREACH_SPACE_EXT(EXT) \
    EXT(1) \
    EXT(2) EXT(3) EXT(4) EXT(5) EXT(6) EXT(7) EXT(8) EXT(9) EXT(10) EXT(11) EXT(12) EXT(13) \
        EXT(14) EXT(15) EXT(16) EXT(17) EXT(18) EXT(19) EXT(20)
#undef FOREACH_COMMA_EXT
#define FOREACH_COMMA_EXT(EXT) \
    EXT(1), EXT(2), EXT(3), EXT(4), EXT(5), EXT(6), EXT(7), EXT(8), EXT(9), EXT(10), EXT(11), \
        EXT(12), EXT(13), EXT(14), EXT(15), EXT(16), EXT(17), EXT(18), EXT(19), EXT(20)
FOREACH
#endif
