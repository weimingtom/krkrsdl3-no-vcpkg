...
tjs_error tTJSNI_Rect::Construct(tjs_int numparams, tTJSVariant** param, iTJSDispatch2* tjs_obj)
{
    if (numparams > 0)
    {
        if (numparams == 1)
        {
            ...
            if (TJS_FAILED(clo.Object->NativeInstanceSupport(
                    TJS_NIS_GETINSTANCE, tTJSNC_Rect::ClassID, (iTJSNativeInstance**)&src)))
                return TJS_E_INVALIDPARAM;
