...
//---------------------------------------------------------------------------
tjs_error tTJSNI_BasePad::Construct(tjs_int numparams, tTJSVariant** param, iTJSDispatch2* dsp)
{
    return TJS_S_OK;
}
//---------------------------------------------------------------------------
...
//----------------------------------------------------------------------
TJS_BEGIN_NATIVE_PROP_DECL(text){TJS_BEGIN_NATIVE_PROP_GETTER{* result = TJS_N("");
return TJS_S_OK;
}
...
//----------------------------------------------------------------------
TJS_BEGIN_NATIVE_PROP_DECL(fileName){TJS_BEGIN_NATIVE_PROP_GETTER{* result = TJS_N("");
return TJS_S_OK;
}
TJS_END_NATIVE_PROP_GETTER
...
//----------------------------------------------------------------------
TJS_BEGIN_NATIVE_PROP_DECL(title){TJS_BEGIN_NATIVE_PROP_GETTER{* result = TJS_N("");
return TJS_S_OK;
}
TJS_END_NATIVE_PROP_GETTER
...
//----------------------------------------------------------------------
TJS_BEGIN_NATIVE_PROP_DECL(fontFace){TJS_BEGIN_NATIVE_PROP_GETTER{* result = TJS_N("");
return TJS_S_OK;
}
TJS_END_NATIVE_PROP_GETTER
...
//----------------------------------------------------------------------
TJS_BEGIN_NATIVE_PROP_DECL(statusText){TJS_BEGIN_NATIVE_PROP_GETTER{* result = TJS_N("");
return TJS_S_OK;
}
TJS_END_NATIVE_PROP_GETTER
