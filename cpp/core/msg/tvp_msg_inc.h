...
TVP_MSG_DEFINE(TVPVersionInformation,
               "Kirikiri 2 Executable core /%1 (Compiled on %DATE% %TIME%) TJS2/%2 Copyright (C) "
               "1997-2013 W.Dee and contributors All rights reserved.")
TVP_MSG_DEFINE(
    TVPVersionInformation2,
...
TVP_MSG_DEFINE(TVPHoldDestinationAlphaParameterIsNowDeprecated,
               "Warring : Method %1 %2th parameter had is ignore. Hold destination alpha parameter "
               "is now deprecated.")
