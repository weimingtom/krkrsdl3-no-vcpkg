...
tjs_error tTJSExtendableObject::FuncCall(tjs_uint32 flag,
...
tjs_error tTJSExtendableObject::CreateNew(tjs_uint32 flag,
                                          const tjs_char* membername,
                                          tjs_uint32* hint,
...
tjs_error tTJSExtendableObject::Operation(tjs_uint32 flag,
                                          const tjs_char* membername,
                                          tjs_uint32* hint,
                                          tTJSVariant* result,
                                          const tTJSVariant* param,
...
tjs_error tTJSExtendableObject::NativeInstanceSupport(tjs_uint32 flag,
                                                      tjs_int32 classid,
