...
#ifdef ENABLE_DEBUGGER
extern void TJSDebuggerHook(tjs_int evtype,
                            const tjs_char* filename,
                            tjs_int lineno,
                            tTJSInterCodeContext* ctx = NULL);
extern void TJSDebuggerLog(const ttstr& line, bool impotant);

extern void TJSDebuggerGetScopeKey(struct ScopeKey& scope,
                                   const tjs_char* classname,
                                   const tjs_char* funcname,
                                   const tjs_char* filename,
                                   int codeoffset);
extern void TJSDebuggerAddLocalVariable(const struct ScopeKey& key,
                                        const tjs_char* varname,
                                        int regaddr);
extern void TJSDebuggerAddLocalVariable(const tjs_char* filename,
                                        const tjs_char* classname,
                                        const tjs_char* funcname,
                                        int codeoffset,
                                        const tjs_char* varname,
                                        int regaddr);
extern void TJSDebuggerGetLocalVariableString(const struct ScopeKey& key,
                                              tTJSVariant* ra,
                                              std::list<std::wstring>& values);
extern void TJSDebuggerGetLocalVariableString(const tjs_char* filename,
                                              const tjs_char* classname,
                                              const tjs_char* funcname,
                                              int codeoffset,
                                              tTJSVariant* ra,
...
extern void TJSDebuggerAddClassVariable(const tjs_char* classname,
                                        const tjs_char* varname,
                                        int regaddr);
extern void TJSDebuggerGetClassVariableString(const tjs_char* classname,
                                              tTJSVariant* ra,
                                              tTJSVariant* da,
                                              std::list<std::wstring>& values);
extern void TJSDebuggerClearLocalVariable(const tjs_char* classname);
