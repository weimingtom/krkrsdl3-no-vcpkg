...
{
    // コピーコンストラクタは未サポート
    TVPThrowExceptionMessage(TJS_N("unimplemented: tTVPCharacterData::tTVPCharacterData(const "
...
{
    if (Data)
        TJSAlignedDealloc(Data), Data = NULL;
...
void tTVPCharacterData::Blur(tjs_int blurlevel, tjs_int blurwidth)
{
    ...
    if (Gray == 256)
        TVPChBlurCopy(newdata, newpitch, newwidth, newheight, Data, Pitch, BlackBoxX, BlackBoxY, bw,
                      blurlevel);
    else
        TVPChBlurCopy65(newdata, newpitch, newwidth, newheight, Data, Pitch, BlackBoxX, BlackBoxY,
                        bw, blurlevel);
...
void tTVPCharacterData::Resample4()
{
    if (FullColored)
        TVPThrowExceptionMessage(
            TJS_N("unimplemented: tTVPCharacterData::Resample4 for FullColored"));
...
void tTVPCharacterData::Resample8()
{
    if (FullColored)
        TVPThrowExceptionMessage(
            TJS_N("unimplemented: tTVPCharacterData::Resample8 for FullColored"));
...
void tTVPCharacterData::AddHorizontalLine(tjs_int liney, tjs_int thickness, tjs_uint8 val)
{
    if (FullColored)
        TVPThrowExceptionMessage(
            TJS_N("unimplemented: tTVPCharacterData::AddHorizontalLine for FullColored"));
