 ...
 * _o          :    with opacity
 */
struct premulalpha_blend_n_a_func
{ // TVPAddAlphaBlend_n_a
    ...
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint32 s) const
    {
        ...
        return sat_add_(
            (((d & 0xff00ff) * sopa >> 8) & 0xff00ff) + (((d & 0xff00) * sopa >> 8) & 0xff00), s);
    }
};
...
/* struct add_aldpha_blend_n_a_o_func {	// TVPAddAlphaBlend_n_a_o
        ...
        inline tjs_uint32 operator()( tjs_uint32 d, tjs_uint32 s, tjs_int opa ) const {
                s = (((s & 0xff00ff)*opa >> 8) & 0xff00ff) + (((s >> 8) & 0xff00ff)*opa &
...
struct premulalpha_blend_a_a_o_func
{ // TVPAddAlphaBlend_a_a_o
...
{
    return (
        ((((color & 0x00ff00) * fac) & 0x00ff0000) + (((color & 0xff00ff) * fac) & 0xff00ff00)) >>
        8);
}
...
struct premulalpha_blend_a_d_func
{ // TVPAddAlphaBlend_a_d
    premulalpha_blend_a_a_func func_;
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint32 s) const
    {
...
struct premulalpha_blend_a_d_o_func
{ // TVPAddAlphaBlend_a_d_o
...
/*
        ...
        Da = Sa + Da - SaDa
*/
struct premulalpha_blend_a_ca_func
{ // = TVPAddAlphaBlend_a_ca
    saturated_u8_add_func sat_add_;
    inline tjs_uint32 operator()(tjs_uint32 dest,
                                 tjs_uint32 sopa,
                                 tjs_uint32 sopa_inv,
                                 tjs_uint32 src) const
    {
        tjs_uint32 dopa = dest >> 24;
        dopa = dopa + sopa - (dopa * sopa >> 8);
        dopa -= (dopa >> 8); /* adjust alpha */
        return (dopa << 24) + sat_add_((((dest & 0xff00ff) * sopa_inv >> 8) & 0xff00ff) +
