...
void tTVPLayerTreeOwner::FireTouchDown(
...
void tTVPLayerTreeOwner::FireTouchUp(
    tjs_real x, tjs_real y, tjs_real cx, tjs_real cy, tjs_uint32 id)
{
    if (!TransformToPrimaryLayerManager(x, y))
        return;
...
void tTVPLayerTreeOwner::FireTouchMove(
    tjs_real x, tjs_real y, tjs_real cx, tjs_real cy, tjs_uint32 id)
{
    if (!TransformToPrimaryLayerManager(x, y))
        return;
...
void tTVPLayerTreeOwner::FireTouchScaling(
...
void tTVPLayerTreeOwner::FireTouchRotate(
...
void tTVPLayerTreeOwner::FireDisplayRotate(
